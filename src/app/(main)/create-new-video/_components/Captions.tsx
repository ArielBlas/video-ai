...
const options = [
  ...
  },
  {
    name: "Glitch",
    style:
      "text-pink-500 text-3xl font-extrabold uppercase tracking-wide drop-shadow-[4px_4px_0_rgba(0,0,0,0.2)] px-3 py-1 rounded-lg",
  },
  {
    name: "Fire",
    style:
...
const Captions = ({ onHandleInputChange }: CaptionsProps) => {
        ...
        {options.map((option, index) => (
          <div
            ...
            onClick={() => {
              ...
              onHandleInputChange("captionStyle", option.style);
            }}
